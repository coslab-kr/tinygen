#include "kernels.h"
#include "cmsis-nn.h"
#ifdef CONV2D_F3X3_S8

extern "C"{
void conv2d_f3x3_s8(Tensor* input, Tensor* weight, Tensor* bias, 
    ...
    Tensor* outTensor = clamp_output ? clamp_output : rescale_output;
    ...
    cmsis_nn_conv_params conv_params;
        ...
        output_dims.n = outTensor->shape[0];
        output_dims.h = outTensor->shape[1];
        output_dims.w = outTensor->shape[2];
        output_dims.c = outTensor->shape[3];
        ...
        arm_convolve_s8(
            ...
            NULL,
            &output_dims,
            static_cast<int8_t*>(outTensor->location)
            );
